...
//Tách ra để tránh hard code. Khó bảo trì. Clean
class TTextTheme {
  TTextTheme._();

  static TextTheme lightTextTheme = TextTheme(
    headlineLarge: const TextStyle().copyWith(fontSize: 32, fontWeight: FontWeight.bold, color: Colors.black), //Không tạo ra constructer mà copy tất cả giá trị muốn thay đổi
